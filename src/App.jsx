          ...
          <div style={{background:"#161b22",borderRadius:16,border:"1px solid #30363d",width:"100%",maxWidth:400,maxHeight:"88vh",display:"flex",flexDirection:"column"}}>
            ...
            <div style={{overflowY:"auto",flex:1,padding:"14px 18px"}}>
              {[
                ...
                {icon:"🏆",title:"클리어 개방 기준",color:"#fcd34d",items:["속성: 기본 5종(불/물/땅/바람/인간) → 1클리어: 전기/얼음/빛/어둠 → 5클리어: 나머지 6종","등급: 기본 노말~영웅 → 1클리어: 전설 → 3클리어: 신화 → 5클리어: 불멸","난이도: 기본 쉬움 → 1클리어: 보통 → 5클리어: 어려움","히든영웅: 0클리어 수호자 → 1 상인 → 2 저격수 → 3 시간술사 → 4 번개신 → 5 연금술사 → 6 도박사"]},
              ].map(section=>(
